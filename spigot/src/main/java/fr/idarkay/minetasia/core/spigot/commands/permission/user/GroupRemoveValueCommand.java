...
/**
 * File <b>GroupRemoveValueCommand</b> located on fr.idarkay.minetasia.core.spigot.commands.permission.user
 * GroupRemoveValueCommand is a part of MinetasiaCore.
 * <p>
 * Copyright (c) 2019 MinetasiaCore.
 * <p>
 *
 * @author alice. B. (IDarKay),
 * Created the 01/12/2019 at 15:56
 */
public class GroupRemoveValueCommand extends SubCommand implements FlexibleCommand {

    public GroupRemoveValueCommand(@NotNull MinetasiaCore plugin) {
        super(plugin, Lang.DESC_PERMISSION_USER_GROUP_REMOVE_VALUE, CommandPermission.PERMISSION_USER_GROUP, 6);
    }

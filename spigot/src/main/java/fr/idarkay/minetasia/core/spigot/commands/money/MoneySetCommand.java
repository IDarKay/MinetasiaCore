...
/**
 * File <b>MoneySetCommand</b> located on fr.idarkay.minetasia.core.spigot.commands.money
 * MoneySetCommand is a part of MinetasiaCore.
 * <p>
 ...
 */
public class MoneySetCommand extends StepCommand implements FixCommand {

    public MoneySetCommand(@NotNull MinetasiaCore plugin) {
        super(plugin, Lang.DESC_MONEY_SET, CommandPermission.MONEY_SET, 4);
            ...
            try
            {
                ...
                if(u != null)
                {
                    try
                    {
                        ...
                        sender.sendMessage(Lang.MONEY_SET.get(lang, Lang.Argument.AMOUNT.match(a), Lang.Argument.MONEY_TYPE.match(e.displayName), Lang.Argument.PLAYER.match(args[1])));
                    }
